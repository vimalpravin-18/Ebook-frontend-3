...
function useTilt(maxTilt = 12, glare = true) {
  ...
  useEffect(() => {
    ...
    function onMove(e) {
      ...
      if (glareEl) {
        glareEl.style.background = `radial-gradient(circle at ${x * 100}% ${
          y * 100
  ...
  const books = useMemo(
    () => [
      ...
      },
      {
        ...
        sampleUrl: "Master Your Minutes.pdf",
    ...
    <>
      ...
      <div className="relative min-h-screen w-380 text-white bg-[#0a0a0f] overflow-hidden">
        ...
        >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="pointer-events-none absolute -inset-1 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                      <div
                        className={`absolute -inset-1 rounded-3xl bg-gradient-to-r ${book.grad} blur-xl opacity-30`}
                      />
                    </div>
                  </article>
                );
          ...
          <footer className="relative py-16 px-6 -mb-40 mt-30 border-t border-white/10 bg-black/30 backdrop-blur-xl">
          ...
          {downloadToken && (
            <div className="mt-12 p-8 rounded-3xl bg-gradient-to-r from-emerald-600/20 to-teal-600/20 backdrop-blur-2xl border border-emerald-500/30 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="flex items-center justify-center gap-4 text-center">
                <div className="flex-shrink-0 w-16 h-16 rounded-2xl bg-emerald-500/20 border border-emerald-400/30 flex items-center justify-center text-3xl">
                  ✅
                </div>
                <div className="flex-1 text-left">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 font-bold shadow-[0_0_30px_rgba(16,185,129,0.3)] hover:shadow-[0_0_50px_rgba(16,185,129,0.5)] transition-all duration-300 transform hover:scale-105"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
          ...
          >
            ...
            >
              ...
              <div className="w-full h-full bg-neutral-950">
                <embed
                  src={preview.sampleUrl} // ✅ DYNAMIC - Uses each book's sample
